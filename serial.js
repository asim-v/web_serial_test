...
class Serial {
   ...
   */
  async autoConnectAndOpenPreviouslyApprovedPort(serialOptions = { baudRate: 115200 }) {
    if (navigator.serial) {
   ...
   */
  async connectAndOpen(portFilters = null, serialOptions = { baudRate: 115200 }) {
